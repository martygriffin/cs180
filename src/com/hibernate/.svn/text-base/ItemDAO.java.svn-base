...
public class ItemDAO extends HibernateDaoSupport {
	...
	public static final String IS_SIDE = "isSide";
	public static final String IS_DRINK = "isDrink";
	public static final String IS_EXTRA = "isExtra";
	public static final String IS_FASTREADY = "isFastready";
	...
	public List findByIngredients(Object ingredients) {
		return findByProperty(INGREDIENTS, ingredients);
	}
	...
	public List findByCustomId(Object customId) {
		return findByProperty(CUSTOM_ID, customId);
	}

	public List findByIsSide(Object isSide) {
		return findByProperty(IS_SIDE, isSide);
	}

	public List findByIsDrink(Object isDrink) {
		return findByProperty(IS_DRINK, isDrink);
	}
	...
	public List findByIsFastready(Object isFastready) {
		return findByProperty(IS_FASTREADY, isFastready);
	}
	...
	public List findByImageLocation(Object imageLocation) {
		return findByProperty(IMAGE_LOCATION, imageLocation);
	}
