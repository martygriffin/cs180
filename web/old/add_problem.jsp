...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Problem</div> 
    ...
    <ul>
<s:form action="problem_save">
  	<li>Probelm Name: <br /><s:textfield name="name"/></li>
  	

  	<li>Is this problem current? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date Onset<br /><s:textfield name=" date_onset" id="datepicker" 
					   		value="%{getText('format.date',{ date_onset})}"/></div><br/>
			<div width="50%" style="float:left;width:50%">Date Resolved<br /><s:textfield name="date_resolved" id="datepicker2" 
					   		value="%{getText('format.date',{date_resolved})}"/></div><br/>
     </div>	
    </li>
    <li>
    <s:hidden name="id" />
    <br/>
     ...
     <s:submit action="problem_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
