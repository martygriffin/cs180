...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Medication</div> 
    ...
    <ul>
<s:form action="medication_save">
  	<li>Medication or supplement<br /><s:textfield name="name"/></li>
  	<li>Are you taking it now? <br />
  	<s:radio name="is_current_medication" value="is_current_medication" list="current_medication"/>
  	</li>
    ...
    <li>Route:<s:select name="selected_route" list="routes_list" /></li>
    <li>Strength:<s:textfield name="strength"/></li>
     <li>How many?<s:select name="selected_amount" list="amount_list" /></li>
      <li>How often?<s:select name="frequency_amount" list="frequency_list" /></li>
    <li>
    <s:hidden name="id" />
    <br/>
     ...
     <s:submit action="medication_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
