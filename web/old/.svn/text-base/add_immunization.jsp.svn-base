...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Immunization</div> 
    ...
    <ul>
<s:form action="immunization_save">
  	<li>What Vaccine did you get? <br /><s:textfield name="vaccine_type"/></li>
  	<li>Who makes this Vaccine?<br/><s:textfield name="vaccineManufacturer"/></li>

  	<li>Is this Vaccine current? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date Administered<br /><s:textfield name="date_administered" id="datepicker" 
					   		value="%{getText('format.date',{date_administered})}"/></div><br/>
			<div width="50%" style="float:left;width:50%">Vaccine Expiration<br /><s:textfield name="vaccine_expiration" id="datepicker2" 
					   		value="%{getText('format.date',{vaccine_expiration})}"/></div><br/>
     </div>	
    </li>
    <li>
    <s:hidden name="id" />
    <br/>
     ...
     <s:if test="!vaccine_type.isEmpty()">
    
     <s:submit action="immunization_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
