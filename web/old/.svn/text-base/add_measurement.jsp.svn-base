...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Measurement</div> 
    ...
    <ul>
<s:form action="measurement_save">
  		<li>Measurement Type: <br /><s:textfield name="type"/></li>
  		<li>Measurement Value: <br /><s:textfield name="value"/></li>
  	 	<li>Measurement Unit: <br /><s:textfield name="Unit"/></li>

  	<li>Is this Measurement current? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date<br /><s:textfield name="date" id="datepicker" 
    ...
    <br/>
     ...
     <s:submit action="measurement_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
