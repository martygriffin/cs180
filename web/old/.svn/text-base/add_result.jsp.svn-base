...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Result</div> 
    ...
    <ul>
<s:form action="result_save">
  		<li>Test Name: <br /><s:textfield name="name"/></li>
  		<li>Result: <br /><s:textfield name="results"/></li>
  		<li>Units: <br /><s:textfield name="units"/></li>
  	 

  	<li>Is this Result current? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date of Result<br /><s:textfield name="date" id="datepicker" 
    ...
    <br/>
     ...
     <s:submit action="result_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
