...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Vital</div> 
    ...
    <ul>
<s:form action="vitals_save">
  		<li>Vital Name: <br /><s:textfield name="name"/></li>
  		<li>Vital Value(needs to be integer or decimal): <br /><s:textfield name="value"/></li>
  		<li>Vital Unit: <br /><s:textfield name="units"/></li>
  		<li>Vital Site: <br /><s:textfield name="site"/></li>
  	 	<li>Vital Position: <br /><s:textfield name="position"/></li>

  	<li>Is this Vital reading recent? <br />
    ...
    <br/>
     ...
     <s:submit action="vitals_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
