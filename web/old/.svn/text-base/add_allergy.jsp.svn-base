...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Allergy</div> 
    ...
    <ul>
<s:form action="allergy_save">
  	<li>What are you allergic to? <br /><s:textfield name="name"/></li>
  	<li>What type of Allergy is it?<br/><s:textfield name="type"/></li>

  	<li>Do you have this problem now? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date Diagnosed<br /><s:textfield name="start_date" id="datepicker" 
    ...
    <br/>
     ...
     <s:submit action="allergy_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
