...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" --> 
    <div class="tab">  
  	...
  	<div id="tabHeader">Add New Simple Clinical Note</div> 
    ...
    <ul>
<s:form action="scn_save">
  		<li>Type of Visit: <br /><s:textfield name="type"/></li>
  		<li>Location of Visit: <br /><s:textfield name="location"/></li>
  		<li>Doctor's Specialty: <br /><s:textfield name="special"/></li>
  		<li>Chief Complaint: <br /><s:textfield name="chiefComplaint"/></li>
  		<li>Content of Note: <br /><s:textfield name="content"/></li>
  	 

  	<li>Is this Simple Clinical Note current? <br />
    ...
    <li>
    	...
    	<div style="position:relative;">
        	...
        	<div width="50%" style="float:left;width:50%">Date of Note<br /><s:textfield name="date" id="datepicker" 
    ...
    <br/>
     ...
     <s:if test="!type.isEmpty()">
    
     <s:submit action="scn_delete" value="Delete" /></div>
   	</s:if>
   	</li>
	</s:form>
    </ul>
