...
<div id="container">
  ...
  <!-- InstanceBeginEditable name="EditRegion2" -->
    ...
    <div class="tab"> 
    <div id="tabHeader">Account Recovery</div>    
  	
  	
<s:form action="register_recover">
  	<div id="tabContent">
    <b>Verification</b><br />
    
    Security Question: <s:property value="questions"/><br />
    Security Answer: <s:textfield name="response"/>
        <s:actionmessage />
		<s:fielderror />
		<s:actionerror />	
    <div class="tabButtons" ><s:submit name="Submit" /> </div>
    </div>
</s:form>
</div>
