		...
		%>
    	  <li><a href="<%=getURL%>">
    	   <s:property  value="#session['leftHeader']"/></a>    	 
					...
					<div id="mainContent">
						<s:if test="all_workshop_class.size() > 0">
							<h3>
								Workshops:
							</h3>
							<s:iterator value="all_workshop_class">
								<s:url id="editURL"
									action="addworkshop_new_reservation_workshop.do">
						...
						<s:else>
					<br/>
						There are no Workshops in your departments
						<br/>
						</s:else>
						<s:if test="all_lab_class.size() > 0">
							<h3>
								Labs:
							</h3>
							<s:iterator value="all_lab_class">
								<s:url id="editURL" action="addlab_new_reservation_lab.do">
									<s:param name="id" value="id" />
								</s:url>
								<li>
									<s:a href="%{editURL}">
						...
						<s:else>
						<br/>
						There are no Labs in your departments
						<br/>
						</s:else>
