...
<div id="container">
    <div id="masthead"><img alt="" src="<%= request.getContextPath() %>/images/managerheader.jpg" width="940" height="55" border="0" usemap="#Map" />
<map name="Map" id="Map">
...
<div id="mainContentNoSidebar">
  ...
  <s:form action="studentlogin.do">   
      <table width="100%" cellpadding="5">
          <tr>
              <td align="right" width="50%">&nbsp;netID:</td>
