...
<area shape="rect" coords="665,34,936,49" href="http://chass.ucr.edu/" alt="CHASS Homepage" />
	...
	<div id="headerContainer">
        <div id="header"><h1>Confirmation</h1></div>
       <div id="userInfo"><p>You are logged in as <strong><s:property value="#session['netID']"/></strong>
...
<div id="mainContent">
Reservation Made. Your confirmation number is ${confirm_number}.
<br/>
