...
<area shape="rect" coords="665,34,936,49" href="http://chass.ucr.edu/" alt="CHASS Homepage" />
	...
	<div id="headerContainer">
        <div id="header"><h1>Make&nbsp; a Reservation<br /></h1></div>
         <div id="userInfo">
...
<div id="mainContent">
ERROR: You are already registered for a lab or workshop or it is full or you are trying to register for multiple sections when not allowed.
<br/>
<INPUT TYPE="BUTTON" VALUE="View Reservations" ONCLICK="window.location.href='student_view_reservations.do'"> 
</div>
