...
<%@ include file="/masthead.jsp" %>
		<div id="headerContainer">
	        <div id="header"><h1>
				<s:if test="%{workshopId == -1}">Add</s:if>
	       		<s:else>Edit</s:else>
				Workshop<br />
	       	</h1></div>
		...
		<div id="mainContent">
		    ...
		    <s:form action="/manager/workshop_save">
			    <table id="addEdit" cellpadding="5">
					<s:hidden name="workshopId" />	
					<tr>
						<td class="name">*Workshop Name:</td>
					...
					<tr>
						<td class="name">Allow Students to Enroll in Multiple Sessions:</td>
					...
					<tr>
						...
						<s:submit name="save" value="Save"/>
					   	<input type="button" value="Cancel" onclick="window.location.href='/wms/manager/view_manage_workshop.do'" /></td>
					</tr>
					<tr>
