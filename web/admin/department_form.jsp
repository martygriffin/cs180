...
<%@ include file="/masthead.jsp" %>
		...
		<div id="mainContent">
			...
			<s:form action="/admin/department_save">
				<s:hidden name="deptId" />
				<table width="100%" id="addEdit" cellpadding="5">
					<tr>
						<td class="name">*College Name:</td>
						<td class="field"><s:select name="colId" list="cols" listKey="id" listValue="name" 
							headerKey="%{#request.NOT_SELECTED}" headerValue="--Select College--" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="field"><s:textfield name="servName"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="name">*Authorization Key:</td>
						<td class="field"><s:textfield name="authKey"/></td>
					</tr>
				    <tr><td></td>
				    	<td colspan="2"><s:submit name="save" value="Save"/>
				    		<input type=button onClick="location.href='/wms/admin/view_departments.do'" value='Cancel'></input>
				    	</td>
				    </tr>
				    <tr>
