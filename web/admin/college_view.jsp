...
<%@ include file="/masthead.jsp" %>
		<div id="headerContainer">
	        <div id="header"><h1>Colleges</h1></div>
		...
		<div id="mainContent">
			...
			<s:url id="addURL" action="/admin/college_input.do" />
			<s:if test="colleges.size() > 0"> 
				<table cellpadding="5" cellspacing="0" id="manage">
					<tr>
						<th class="col_name">Name</th><th class="url">URL</th>
						<th class="univ_name">University</th>
					...
					<s:iterator value="colleges">
			        	<tr>
			        		<s:url id="editURL" action="/admin/college_input.do">
								<s:param name="id" value="id" />
							</s:url>
							<s:url id="deleteURL" action="/admin/college_delete.do">
								<s:param name="id" value="id" />
							</s:url>
							<td class="col_name"><s:property value="name" /></td>
							<td class="url"><s:a href="homeUrl"><s:property value="homeUrl"/></s:a></td>
							<td class="univ_name"><s:property value="university.name"/></td>
							<td class="buttons">
								<s:a href="%{editURL}"><img src="<%= request.getContextPath() %>/images/page_white_edit.png" alt="View/Edit College" width="25" height="25" border="0" /></s:a>
								<s:a href="%{deleteURL}" onclick="return delete_college();"><img src="<%= request.getContextPath() %>/images/page_white_delete.png" alt="Delete College" width="25" height="25" border="0" /></s:a>
							</td>
						</tr>
					</s:iterator>
				</table>
