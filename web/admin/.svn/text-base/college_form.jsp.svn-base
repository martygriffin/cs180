...
<%@ include file="/masthead.jsp" %>
		...
		<div id="mainContent">
			...
			<s:form action="/admin/college_save">
				<s:hidden name="colId" />
				<table width="100%" id="addEdit" cellpadding="5">
					<tr>
						<td class="name">*University Name:</td>
						<td class="field"><s:select name="univId" list="univs" listKey="id" listValue="name" 
							headerKey="%{#request.NOT_SELECTED}" headerValue="--Select University--" /></td>
					</tr>
					<tr>
				    ...
				    <tr><td></td>
				    	<td colspan="2"><s:submit name="save" value="Save"/>
				    		<input type=button onClick="location.href='/wms/admin/view_colleges.do'" value='Cancel'></input>
				    	</td>
				    </tr>
				    <tr>
