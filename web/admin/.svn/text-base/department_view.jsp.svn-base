...
<%@ include file="/masthead.jsp" %>
		<div id="headerContainer">
	        <div id="header"><h1>Departments</h1></div>
		...
		<div id="mainContent">
			...
			<s:url id="addURL" action="/admin/department_input.do" />
			<s:if test="departments.size() > 0"> 
				<table cellpadding="5" cellspacing="0" id="manage">
					<tr>
						<th class="dept_name">Name</th><th class="url_small">URL</th>
						<th class="col_name">College</th><th class="authkey">Auth. Key</th>
						<th class="buttons"><s:a href="%{addURL}"><img src="<%= request.getContextPath() %>/images/page_white_add.png" alt="Add Department" width="25" height="25" border="0" /></s:a></th>
					</tr>
					<s:iterator value="departments">
			        	<tr>
			        		<s:url id="editURL" action="/admin/department_input.do">
								<s:param name="id" value="id" />
							</s:url>
							<s:url id="deleteURL" action="/admin/department_delete.do">
								<s:param name="id" value="id" />
							</s:url>
							<td class="dept_name"><s:property value="name"/></td>
							<td class="url_small"><s:a href="homeUrl"><s:property value="homeUrl"/></s:a></td>
							<td class="col_name"><s:property value="college.name" /></td>
							<td class="authkey"><s:property value="authKey" /></td>
							<td class="buttons">
								...
								<s:a href="%{deleteURL}" onclick="return delete_department();"><img src="<%= request.getContextPath() %>/images/page_white_delete.png" alt="Delete Department" width="25" height="25" border="0" /></s:a>
							</td>
						</tr>
					</s:iterator>
				</table>
